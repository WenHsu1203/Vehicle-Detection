...
The code for this step is contained in lines 6 through 25 of the file called 'utility.py'(or in lines # through # of the file called `some_file.py`).  
...
I used the parameters from the lectures and it seems work not too bad, thus it remains.
...
Ultimately I searched on three scales using HLS and 3-channel HOG features plus spatially binned color and histograms of color in the feature vector, which provided a nice result.  Here are some example images:
...
I cannot detect the cars perfectly most of the time, and when two cars are close, the program cannot differentiate them. I think I should spend more time on the choosing of window size.   
